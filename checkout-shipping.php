                ...
                <div class="md:grid md:grid-cols-2 md:items-start" id="sticky-container">
                  <div class="py-40 lg:py-80 px-15 laptop:px-120">
                    <div class="text-center">
                      <a class="inline-flex mb-30" href="<?php echo home_url(); ?>"><svg class="max-w-full block logo-food w-130 md:w-250 h-auto mx-auto" width="564" height="112" viewbox="0 0 564 112" fill="none" xmlns="http://www.w3.org/2000/svg">
