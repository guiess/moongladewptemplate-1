                ...
                <div class="md:grid md:grid-cols-2 md:items-start" id="sticky-container">
                  <div class="py-40 lg:py-80 px-15 laptop:px-120">
                    <div class="text-center">
                      <a class="inline-flex mb-30" href="catalog.php"><svg class="max-w-full block logo-food w-130 md:w-250 h-auto mx-auto" width="564" height="112" viewbox="0 0 564 112" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <form name="customerinfo" class="form-theme--dark">
                        <div class="mb-45">
                          <div class="form-group">
                            <div class="form-group__control input-editable"><input name="customerShippingEmail" data-inputmask-regex="^[a-zA-Z0-9.!#$%&'+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:.[a-zA-Z0-9-]+)$" class="form-control" type="text" placeholder="E-mail" pattern="^[a-zA-Z0-9.!#$%&'+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:.[a-zA-Z0-9-]+)$" readonly />
                              <p class="btn-edit">Edit</p>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="form-group__control input-editable"><input name="customerShippingAddress" data-inputmask-regex="[A-z0-9,-\s]{1,60}" class="form-control" type="text" placeholder="Address" readonly />
                              <p class="btn-edit">Edit</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="text-right pt-20">
                          <button class="btn btn--light button-wide-mobile js-btn-continue">
                          ...
                          <form class="form-theme--light mb-25" data-component="discount-form">
                            <div class="flex items-center">
                              ...
                              <div class="flex-shrink-0 ml-15">
                                <button class="btn btn--primary js-button-apply-disount" disabled="false" type="button">
