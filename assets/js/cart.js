      ...
      <div class="cart-product uppercase flex items-start">
        ...
        <div class="flex-grow">
          <h4 class="cart-product__title laptop:w-8/12">${name}</h4>
            ...
            <input class="js-cart-input-price" type="hidden" name="${id}-Price" value="${
      price * quantity
    }">
          <div class="cart-product__info-line flex justify-between items-baseline">
            <div class="cart-product__info-item">
              <span>$ ${price}</span><span class="opacity-50 weight js-cart-item-weight">(100<span class="lowercase">gr</span>)</span>
            </div>
            <div class="cart-product__info-item"><span class="js-cart-item-price">$ ${
              price * quantity
            }</span></div>
          </div>
