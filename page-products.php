...
<body class="page-products header-secondary">
              ...
              <div class="header-menu__holder">
                ...
                <div class="header-menu__scroller flex flex-col flex-grow" data-menu-scroller="">
                  <div class="flex-grow flex items-center justify-center lg:block">
                    <ul class="main-nav main-nav--main">
                      <li class="main-nav__item"><a class="link" href="<?php echo get_template_directory_uri(); ?>/products/">SuperFood </a></li>
                      <li class="main-nav__item"><a class="link" href="<?php echo get_template_directory_uri(); ?>/films/" target="_blank">Films</a></li>
                      <li class="main-nav__item"><a class="link" href="<?php echo get_template_directory_uri(); ?>/sounds/">Sound</a></li>
                    </ul>
                  </div>
                </div>
                <div class="header-menu__subnav text-center grid gap-10 lg:hidden">
                  ...
                  <ul class="list--tilda">
                    ...
                    <li class="header-nav__stagger"><a class="link" href="<?php echo get_template_directory_uri(); ?>/termsconditions/">Terms & Conditions</a></li>
                  </ul>
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_01" data-component="popup">
      ...
      <div class="popup-body lg:grid lg:grid-cols-12 bg-white text-black">
        <div class="lg:col-span-7 lg:order-2 lg:flex lg:flex-col product-popup__visual-part">
          ...
          <div class="flex-grow product-popup__visual">
            <picture><img class="w-full max-w-full transition-opacity duration-300 lg:w-full lg:h-full lg:object-cover" data-component="lazyload" data-animate="data-animate" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 9'%3E%3C/svg%3E" data-srcset="<?php echo get_template_directory_uri() . "/assets/"; ?>images/products/product-image01@2x.jpg" alt="image description" /></picture>
          </div>
        </div>
        <div class="lg:col-span-5 product-popup__content-part" data-component="product">
          <div class="product-popup__content-scroller">
            <h2 class="product-popup__title font-serif" data-product-title="">TURMERIC</h2>
            <p class="product-popup__price font-serif"><span>$ 30</span><span class="opacity-50 ml-5">(150gr)</span></p>
            ...
            <div class="wysiwyg">
              <p>Powerhouse your body, liver and all immune system with this gold medicinal herb.</p>
              <p>
                To unleash the magick of Curcumin it is advised to heat it or mix with healthy fats like coconut oil. USE 1 teaspoon with water, tea, milk , smoothie or adding to
                food like curry.
              </p>
            </div>
            <p class="product-popup__excerpt uppercase font-serif">F EEL T H E P OWE R A L L D A Y</p>
            ...
            <div class="product-popup__definitions grid">
              <dl class="mb-0">
                ...
                <dd>Anytime of the day.</dd>
              </dl>
              <dl class="mb-0">
                <dt class="opacity-50">Contains:</dt>
                <dd>
                  Curcumin, antioxidants, iron, potassium, <br />
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_02" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
      ...
      <div class="popup-body lg:grid lg:grid-cols-12 bg-white text-black">
        <div class="lg:col-span-7 lg:order-2 lg:flex lg:flex-col product-popup__visual-part">
          ...
          <div class="flex-grow product-popup__visual">
            <picture><img class="w-full max-w-full transition-opacity duration-300 lg:w-full lg:h-full lg:object-cover" data-component="lazyload" data-animate="data-animate" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 9'%3E%3C/svg%3E" data-srcset="<?php echo get_template_directory_uri() . "/assets/"; ?>images/products/product-image02@2x.jpg" alt="image description" /></picture>
          </div>
        </div>
        <div class="lg:col-span-5 product-popup__content-part" data-component="product">
          <div class="product-popup__content-scroller">
            <h2 class="product-popup__title font-serif" data-product-title="">NONI</h2>
            <p class="product-popup__price font-serif"><span>$ 30</span><span class="opacity-50 ml-5">(150gr)</span></p>
            <div class="product-popup__buttons-panel flex justify-between">
              <div class="product-popup__button-item flex-shrink-0">
                <div class="stepper" data-component="stepper" data-min="1" data-max="100" data-step="1">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_03" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
      ...
      <div class="popup-body lg:grid lg:grid-cols-12 bg-white text-black">
        <div class="lg:col-span-7 lg:order-2 lg:flex lg:flex-col product-popup__visual-part">
          ...
          <div class="flex-grow product-popup__visual">
            <picture><img class="w-full max-w-full transition-opacity duration-300 lg:w-full lg:h-full lg:object-cover" data-component="lazyload" data-animate="data-animate" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 9'%3E%3C/svg%3E" data-srcset="<?php echo get_template_directory_uri() . "/assets/"; ?>images/products/product-image03@2x.jpg" alt="image description" /></picture>
          </div>
        </div>
        <div class="lg:col-span-5 product-popup__content-part" data-component="product">
          <div class="product-popup__content-scroller">
            <h2 class="product-popup__title font-serif" data-product-title="">Moringa</h2>
            <p class="product-popup__price font-serif"><span>$ 30</span><span class="opacity-50 ml-5">(150gr)</span></p>
            <div class="product-popup__buttons-panel flex justify-between">
              <div class="product-popup__button-item flex-shrink-0">
                <div class="stepper" data-component="stepper" data-min="1" data-max="100" data-step="1">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_04" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
      ...
      <div class="popup-body lg:grid lg:grid-cols-12 bg-white text-black">
        <div class="lg:col-span-7 lg:order-2 lg:flex lg:flex-col product-popup__visual-part">
          ...
          <div class="flex-grow product-popup__visual">
            <picture><img class="w-full max-w-full transition-opacity duration-300 lg:w-full lg:h-full lg:object-cover" data-component="lazyload" data-animate="data-animate" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 9'%3E%3C/svg%3E" data-srcset="<?php echo get_template_directory_uri() . "/assets/"; ?>images/products/product-image04@2x.jpg" alt="image description" /></picture>
          </div>
        </div>
        <div class="lg:col-span-5 product-popup__content-part" data-component="product">
          <div class="product-popup__content-scroller">
            <h2 class="product-popup__title font-serif" data-product-title="">RED GINGER</h2>
            <p class="product-popup__price font-serif"><span>$ 30</span><span class="opacity-50 ml-5">(150gr)</span></p>
            <div class="product-popup__buttons-panel flex justify-between">
              <div class="product-popup__button-item flex-shrink-0">
                <div class="stepper" data-component="stepper" data-min="1" data-max="100" data-step="1">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_05" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
      ...
      <div class="popup-body lg:grid lg:grid-cols-12 bg-white text-black">
        ...
        <div class="lg:col-span-5 product-popup__content-part" data-component="product">
          <div class="product-popup__content-scroller">
            <h2 class="product-popup__title font-serif" data-product-title="">MANGOSTEENA</h2>
            <p class="product-popup__price font-serif"><span>$ 30</span><span class="opacity-50 ml-5">(150gr)</span></p>
            <div class="product-popup__buttons-panel flex justify-between">
              <div class="product-popup__button-item flex-shrink-0">
                <div class="stepper" data-component="stepper" data-min="1" data-max="100" data-step="1">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_06" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_07" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_08" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_09" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_10" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
  ...
  <div class="fixed top-0 w-full h-full z-110 popup popup--modal popup--full product-popup" id="product_11" data-component="popup">
    <span class="bg-black absolute w-full h-full left-0 top-0 popup-overlay" data-popup-close=""></span>
    <div class="popup-container h-full max-h-full relative overflow-y-auto" data-popup-scroller="">
      <div class="popup-close">
        <button class="btn btn--primary" type="button" data-popup-close="">
    ...
    <div class="bg-gray-800 text-white p-15 lg:px-40 lg:py-25 text-sm md:flex md:items-center md:justify-between max-w-800 ml-auto rounded-3xl">
      ...
      <div class="grid justify-between gap-20 grid-flow-col items-center md:justify-end flex-shrink-0">
        <button class="btn btn--light py-10 h-46" type="button" data-control="accept">
          <span class="btn__text-holder"><span class="btn__text">Accept cookies</span></span></button><button class="btn btn--outline w-46 h-46 rounded-full border-white border-opacity-10 text-white p-0 hover:text-black text-xxs" type="button" data-control="decline">
          <span class="btn__text-holder"><i class="btn__icon btn__icon--append icon-close"></i></span>
        </button>
      </div>
    </div>
