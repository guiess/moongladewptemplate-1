                    ...
                    <div class="hidden-form-empty-cart">
                      <form name="customerinfo" class="form-theme--dark">
                        ...
                        <div class="md:flex md:justify-between md:items-center pt-20">
                          ...
                          <button class="btn btn--light button-wide-mobile js-btn-paynow" type="button">
