<?php
/*
Template Name: Страница с Вводом данных покупателя
*/
?>
      ...
      <div class="w-full h-full preloader-holder relative">
        <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-7/10 flex justify-center">
          <div class="relative" data-preloader-image="">
            <img src="images/preloader/image01@2x.jpg" width="276" height="163" alt="preloader" /><span
                  ...
                  <div class="md:grid md:grid-cols-2 md:items-start" id="sticky-container">
                    <div class="py-40 lg:py-80 px-15 laptop:px-120">
                      <div class="text-center">
                        <a class="inline-flex mb-30" href="/index.html"
                          ><svg
                            class="max-w-full block logo-food w-130 md:w-250 h-auto mx-auto"
                            width="564"
                            height="112"
                            viewbox="0 0 564 112"
                            fill="none"
                      ...
                      <form class="form-theme--dark" action="/checkout-shipping.html">
                        <div class="form-group">
                          <div class="form-group__control"><input class="form-control" type="email" placeholder="E-mail" /></div>
                        </div>
                        <div class="form-group">
                          <div class="form-group__control"><input class="form-control" type="text" placeholder="First name" /></div>
                        </div>
                        <div class="form-group">
                          <div class="form-group__control"><input class="form-control" type="text" placeholder="Last name" /></div>
                        </div>
                        <div class="form-group">
                          <div class="form-group__control"><input class="form-control" type="text" placeholder="Address" /></div>
                        </div>
                        <div class="form-group">
                          <div class="form-group__control"><input class="form-control" type="text" placeholder="Apartment, suite, etc.  " /></div>
                        </div>
                        <div class="md:grid md:grid-cols-2 md:gap-x-20">
                          ...
                          <div class="form-group">
                            <div class="form-group__control"><input class="form-control" type="text" placeholder="Postal code" /></div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="form-group__control"><input class="form-control" type="text" placeholder="Phone (optional)" /></div>
                        </div>
                        <div class="text-right pt-20">
                          <button class="btn btn--light" type="submit">
                            <span class="btn__text-holder"><span class="btn__text">Continue</span></span>
                          </button>
                        </div>
                      </form>
                    </div>
                    <div
                      class="fixed bottom-0 right-0 w-full md:static"
                      data-component="checkout-products"
                      data-scroll=""
                      data-scroll-sticky=""
                    ...
                    >
                      <div class="w-full text-black bg-white pb-80 md:pb-0" data-products="">
                        <div class="overflow-y-auto md:overflow-visible max-h-full h-full" data-scroller="">
                          <div class="px-15 md:px-30 laptop:px-50 border-b border-black-100">
                              ...
                              <div class="cart-product__visual overflow-hidden flex-shrink-0">
                                <picture
                                  ><img
                                    ...
                                    data-srcset="images/products/product-image01-hover.jpg"
                              ...
                              <div class="cart-product__visual overflow-hidden flex-shrink-0">
                                <picture
                                  ><img
                                    ...
                                    data-animate="data-animate"
                                    src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 9'%3E%3C/svg%3E"
                                    data-srcset="images/products/product-image04-hover.jpg"
                                    alt="image description"
                                /></picture>
                              </div>
                              <div class="flex-grow">
                                <h4 class="cart-product__title laptop:w-8/12">ACTIVATED COCONUT CHARCOAL</h4>
                                <div class="cart-product__info-line flex justify-between items-baseline">
                                  <div class="cart-product__info-item">
                                    <span>$ 30</span><span class="opacity-50 weight">(100<span class="lowercase">gr</span>)</span>
                                  </div>
                          ...
                          <div class="px-15 md:px-30 laptop:px-50 py-25 lg:py-30 border-b border-black-100">
                            <form class="form-theme--light mb-25" action="#" data-component="discount-form">
                              <div class="flex">
                                <div class="flex-grow"><input class="form-control" type="text" placeholder="Discount code " /></div>
                                <div class="flex-shrink-0 ml-15">
                                  <button class="btn btn--primary" type="button">
                                    <span class="btn__text-holder"><span class="btn__text">apply</span></span>
                                  </button>
                                </div>
                              </div>
                            </form>
                            <div class="mb-25 flex justify-between items-center p-15 lg:p-20 rounded-md lg:rounded-2xl bg-black-50">
                              <span class="uppercase mr-10 text-sm lg:text-md">superfood</span
                              ><span class="w-20 h-20 rounded-full text-white bg-black-200 inline-flex items-center justify-center"
                                ><svg width="8" height="6" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path
                                    d="M3.41782 5.93809C3.34481 6.01521 3.21855 6.0211 3.13724 5.95115L0.063382 3.3067C-0.0179317 3.23675 -0.0214671 3.11906 0.0554389 3.04515L1.03479 2.1045C1.11174 2.03059 1.24122 2.02738 1.32253 2.09728L3.00165 3.54175C3.08297 3.61169 3.20923 3.60581 3.28223 3.52868L6.56265 0.0641111C6.63566 -0.0130139 6.76486 -0.0218198 6.84966 0.0445795L7.92947 0.889365C8.01432 0.955723 8.024 1.07316 7.95096 1.15029L3.41782 5.93809Z"
                                    fill="currentColor"
                                  /></svg
                              ></span>
                            </div>
                            <div class="flex justify-between items-baseline text-sm lg:text-md"><span>Subtotal:</span><span>$ 90</span></div>
                            <div class="flex justify-between items-baseline text-sm lg:text-md mt-10"><span>Shipping:</span><span>15$</span></div>
                            <div class="flex justify-between items-baseline text-sm lg:text-md mt-10"><span>Discount code:</span><span>-20$</span></div>
                          </div>
                        </div>
                      </div>
                      <div class="bg-white text-black rounded-t-2xl md:rounded-none p-15 md:p-30 laptop:px-50 laptop:py-45 uppercase leading-none" data-toggle="">
                        <div class="grid grid-cols-3 items-center md:items-baseline text-lg lg:text-2xl">
                          <span>total:</span>
                          <div class="text-center">
                            <span class="md:invisible md:pointer-events-none"
                              ><span class="checkout-summary__toggler w-30 h-30 rounded-full inline-flex items-center justify-center"
                                ><svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M4 -3.49691e-07L0.535899 4.5L7.4641 4.5L4 -3.49691e-07Z" fill="currentColor" /></svg></span
                            ></span>
                          </div>
      ...
      <div class="popup-container max-h-full lg:flex relative overflow-y-auto lg:overflow-visible" data-popup-scroller="">
        ...
        <div class="popup-body bg-white text-black lg:max-h-full">
          <div class="py-65 px-25 md:py-80 md:px-90" data-popup-scroller="">
            ...
            <div class="max-w-350 reset-last opacity-80"><p>Your order has been placed and is being processed. You will receive an E-mail with the order details.</p></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="bg-gray-800 text-white p-15 lg:px-40 lg:py-25 text-sm md:flex md:items-center md:justify-between max-w-800 ml-auto rounded-3xl">
        ...
        <div class="grid justify-between gap-20 grid-flow-col items-center md:justify-end flex-shrink-0">
          <button class="btn btn--light py-10 h-46" type="button" data-control="accept">
            <span class="btn__text-holder"><span class="btn__text">Accept cookies</span></span></button
